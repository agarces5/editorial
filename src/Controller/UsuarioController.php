...
class UsuarioController extends AbstractController
{
    ...
    #[Route('/{nickname}', name: 'app_usuario_show', methods: ['GET'])]
    ...
    #[Route('/{nickname}/edit', name: 'app_usuario_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{nickname}', name: 'app_usuario_delete', methods: ['POST'])]
    public function delete(Request $request, Usuario $usuario, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$usuario->getUuid(), $request->request->get('_token'))) {
